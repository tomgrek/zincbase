...
b = kb.query('append([a, b], [c, d], X)'); assert len(b) == 1; assert b[0]['X'] == '[a,b,c,d]'
b = kb.query('append([a, b], X, [a, b, c, d])'); assert len(b) == 1; assert b[0]['X'] == '[c,d]'
b = kb.query('append(X, Y, [a, b, c, d])'); assert len(b) == 5; assert b[0]['X'] == '[]'; assert b[0]['Y'] == '[a,b,c,d]'
